...
class AdicionarAoCarrinho(View):
    def get(self, *args, **kwargs):
        ...
        # Basicamente ele vai e volta para mesma página (quando você adiciona ao carrinho, você não sai da página, você só adiciona).
        ...
        if variacao_id in carrinho:
            ...
            carrinho[variacao_id]['preco_quantidativo'] = preco_unitario * quantidade_carrinho
            carrinho[variacao_id]['preco_quantidativo_promocional'] = preco_unitario_promocional * quantidade_carrinho
        else:
